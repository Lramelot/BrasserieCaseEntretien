...
namespace WebApi.Migrations
{
    ...
    [Migration("20201213134229_Init15")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BeerWholesaler", b =>
                {
                    b.Property<int>("WBeersListBeerId")
                        .HasColumnType("int");

                    b.Property<int>("WholesalerListBeerWholesalerId")
                        .HasColumnType("int");

                    b.HasKey("WBeersListBeerId", "WholesalerListBeerWholesalerId");

                    b.HasIndex("WholesalerListBeerWholesalerId");

                    b.ToTable("BeerWholesaler");
                });
            ...
            modelBuilder.Entity("BeerWholesaler", b =>
                {
                    b.HasOne("WebApi.Models.Beer", null)
                        .WithMany()
                        .HasForeignKey("WBeersListBeerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("WebApi.Models.Wholesaler", null)
                        .WithMany()
                        .HasForeignKey("WholesalerListBeerWholesalerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
